...
import GrpcErrorHandlerMiddleware from './handler_interceptors/grpc_error_handler_interceptor';
...
Chitti.add_handler_interceptor(new GrpcErrorHandlerMiddleware());
